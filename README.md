...
## 💬 聯絡方式
如有疑義，請聯絡Discord`@Farmertree8`或其他管理員，或是創建issue。
...
- QOL improvement from [BennyDioxide](https://github.com/Farmertree8/SWTW-history/pull/3) 
- 所有透過 GitHub 協作平台提交的筆記與內容，將視為 **開放授權給本專案及其未來發展用途使用**，原作者擁有原始內容著作權。若需引用、改編、重製內容，請註明出處或作者 ID（未註名通常為專案持有人Farmertree8所貢獻）。

請以尊重為原則，歡迎路過的人留下筆記或對我爛到沒剩的的程式碼提出建議。
